"""Cross-chunk contradiction guard for review findings (#2265).
...
The guard sits beside the P1 evidence gate in
:mod:`lintro.ai.review.severity_gate`, which re-exports every public name here
...
def describe_cross_chunk_contradictions(*, findings: Iterable[ReviewFinding]) -> str:
    ...
    Returns:
        A line such as ``"1 finding tagged as cross-chunk contradictions (1
        downgraded one band): evidence claims a changed file was never
        touched"``, or an empty string when nothing was tagged.
    """
