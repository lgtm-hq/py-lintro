...
Both :mod:`lintro.tools.tsc.definition` and
:mod:`lintro.tools.vue_tsc.definition` drive a TypeScript compiler binary
...
from lintro.tools.ts_checker import command as ts_cmd
from lintro.tools.ts_checker import execution as ts_exec
...
class TypeScriptCheckerPlugin(BaseToolPlugin):
    ...
    def _preferred_candidate_tsconfig(self, discovery_root: Path) -> Path | None:
        ...
        such as :class:`~lintro.tools.vue_tsc.definition.VueTscPlugin` — which
