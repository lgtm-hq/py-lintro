...
- **tests**: freeze the clocks behind two wall-clock flakes (#2791) (9e66208)
...
- **ai/review**: diff-bounded finding gate: a chunk finding whose line lies outside
  ...
  changed line, and occurrences are checked individually; counts are reported as
...
- **release**: record the #2633 scenario runs and close out the validation runbook
  (#2698) (3996683)
...
- **ci**: weekly provider API smoke, manual-only CLI smoke, replay fixtures (#2614)
  (81378a4)
