...
def test_validate_safe_path_dot_relative_path_is_safe(
    tmp_path: Path,
...
def test_validate_safe_path_uses_cwd_when_no_base_dir(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_validate_safe_path_empty_path_behavior(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_validate_safe_path_current_dir_is_safe(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
def test_normalize_file_path_for_display_nested_path_normalized(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
