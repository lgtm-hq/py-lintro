...
BASELINE: dict[str, tuple[str, ...]] = {
    ...
    "lintro/tools/definitions/oxfmt.py": ("PLR0912", "PLR0915"),
    "lintro/tools/definitions/oxlint.py": ("C901", "PLR0912", "PLR0913", "PLR0915"),
    "lintro/tools/definitions/prettier.py": ("C901", "PLR0912", "PLR0915"),
