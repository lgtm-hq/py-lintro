...
def test_claude_cli_init_cli_transport_available(
...
def test_claude_cli_complete_success(_mock_claude_on_path: None) -> None:
...
def test_claude_cli_complete_cli_schema_flag_when_requested(
    _mock_claude_on_path: None,
) -> None:
...
def test_claude_cli_complete_auth_error(_mock_claude_on_path: None) -> None:
