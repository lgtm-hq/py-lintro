...
class TestMetadataHelpers:
    """Tests for metadata attachment and normalization."""

    def test_summary_and_fixes_coexist(self):
    ...
    def test_normalize_supports_legacy_suggestions_key(self):
        raw = {
    ...
    def test_fixed_count_is_attached_and_normalized(self):
        result = ToolResult(name="ruff", success=True)
        ...
        assert_that(normalized).contains_key("applied_count")
        assert_that(normalized).contains_key("verified_count")
        assert_that(normalized).contains_key("unverified_count")
