...
class TestDetectPRNumber:
    """Tests for PR number detection from GITHUB_REF."""

    def test_detects_pr_number_from_ref(self) -> None:
    ...
    def test_returns_none_for_malformed_ref(self) -> None:
...
class TestGitHubPRReporter:
    """Tests for the GitHubPRReporter class."""

    def test_is_available_with_all_context(self, test_token: str) -> None:
    ...
    def test_is_not_available_without_repo(self, test_token: str) -> None:
    ...
    def test_is_not_available_without_pr_number(self, test_token: str) -> None:
    ...
    def test_post_review_comments_returns_false_when_unavailable(self) -> None:
    ...
    def test_post_review_comments_posts_summary(self, test_token: str) -> None:
    ...
    def test_post_review_comments_posts_suggestions(self, test_token: str) -> None:
    ...
    def test_api_request_constructs_correct_request(self, test_token: str) -> None:
...
class TestFormatSummaryComment:
    """Tests for summary comment formatting."""
    ...
    def test_includes_key_patterns(self) -> None:
    ...
    def test_includes_priority_actions(self) -> None:
    ...
    def test_includes_triage_suggestions(self) -> None:
    ...
    def test_includes_effort_estimate(self) -> None:
...
class TestFormatInlineComment:
    ...
    def test_includes_code_and_tool(self) -> None:
    ...
    def test_sanitizes_backticks_in_diff(self) -> None:
