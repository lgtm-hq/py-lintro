...
class TestToolCwd:
    """Tests for _tool_cwd context manager."""

    def test_tool_cwd_restores_original_cwd(self, tmp_path: Path) -> None:
    ...
    def test_tool_cwd_skips_when_none(self) -> None:
...
class TestPathsForContext:
    """Tests for paths_for_context."""

    def test_paths_for_context_relativizes_paths(self, tmp_path: Path) -> None:
    ...
    def test_paths_for_context_returns_originals_when_no_cwd(self) -> None:
...
class TestRerunTools:
    """Tests for rerun_tools."""

    def test_rerun_tools_with_missing_tools(self) -> None:
...
class TestApplyRerunResults:
    """Tests for apply_rerun_results."""

    def test_apply_rerun_results_preserves_native_counters(self) -> None:
    ...
    def test_apply_rerun_results_updates_remaining_issues(self) -> None:
        ...
        assert original_result.issues is not None
