...
- `GitHub rate limit (HTTP 403)` — the token was throttled, by the primary API quota or
  the secondary content-creation limit (HTTP 403 or 429); the next round posts the
  comments.
