...
| `format-lintro-pr-comment.py`       | Format lintro output or job logs into exact PR comment markdown       | `python3 scripts/ci/format-lintro-pr-comment.py --job-log lint-job.log --status-file status.txt --content-file body.md` |
