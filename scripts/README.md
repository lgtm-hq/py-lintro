...
| `generate-tool-versions.py`          | Generate `_generated_versions.py` and sync `manifest.json` versions (shim over `lintro_build/`)  | `python scripts/ci/generate-tool-versions.py [--check]`                                                                    |
...
| `generate-builtin-tool-index.py`     | Generate `lintro/plugins/_builtin_index.py` from the definitions dir (shim over `lintro_build/`) | `python scripts/ci/generate-builtin-tool-index.py [--check]`                                                               |
