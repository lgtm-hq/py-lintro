...
| `maintenance/delete-ci-ghcr-tags.sh` | Delete ephemeral CI GHCR tags (sole-tag versions only; #1138)         | `CI_TAG=ci-123 ./scripts/ci/maintenance/delete-ci-ghcr-tags.sh`                    |
| `maintenance/sweep-ci-ghcr-tags.sh`  | Age-based scheduled sweep of orphaned ephemeral `ci-*` GHCR tags      | `GH_TOKEN=… ./scripts/ci/maintenance/sweep-ci-ghcr-tags.sh --help`                 |
