...
| `nuitka_bytecode_plugin.py`           | Nuitka user plugin shipping pygments as bytecode instead of compiled C (#2514)                              | passed to Nuitka via `--user-plugin` by the two build scripts            |
...
| `resolve-nuitka-version.py`                 | Resolve the Nuitka version `uv.lock` pins, for the binary build cache key (#2514)                                                | `python3 scripts/ci/resolve-nuitka-version.py`                                                                             |
