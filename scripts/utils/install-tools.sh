...
SUPPORTED_TOOLS=(
	...
	"clippy" "commitlint" "djlint" "dotenv-linter" "gitleaks" "golangci-lint" "hadolint" "html-validate" "markdownlint" "markdownlint-cli2" "mypy" "osv-scanner"
