...
SUPPORTED_TOOLS=(
	...
	"clippy" "commitlint" "dotenv-linter" "gitleaks" "golangci-lint" "hadolint" "html-validate" "j2lint" "markdownlint" "markdownlint-cli2" "mypy" "osv-scanner"
