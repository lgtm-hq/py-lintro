...
SUPPORTED_TOOLS=(
	...
	"clippy" "commitlint" "gitleaks" "hadolint" "ktlint" "markdownlint" "markdownlint-cli2" "mypy" "osv-scanner"
...
main() {
	...
	tools_to_verify=("actionlint" "astro" "bandit" "black" "cargo-audit" "cargo-deny" "clippy" "commitlint" "rustfmt" "gitleaks" "hadolint" "ktlint" "markdownlint-cli2" "mypy" "osv-scanner" "oxfmt" "oxlint" "prettier" "pydoclint" "ruff" "semgrep" "shellcheck" "shfmt" "sqlfluff" "svelte-check" "taplo" "tsc" "vale" "vue-tsc" "yamllint")
